...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen pt-32 pb-20 overflow-hidden flex flex-col items-center">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-[30rem] h-[30rem] bg-pink-400/20 rounded-full blur-[120px] -z-10" />

      <div className="container px-6 flex flex-col items-center text-center max-w-5xl mx-auto">
        ...
        >
          Upload your business once. Aura AI understands everything. 
          Your AI employees plan, market, automate, analyse, create documents, 
          send emails, manage customers, build websites, and help grow your 
          company while you stay in control.
        </motion.p>
        ...
        >
          <Button size="lg" onClick={() => window.location.href='/login'} className="rounded-full px-8 h-14 bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white shadow-xl shadow-purple-500/25 border-0 hover:scale-105 transition-transform text-base font-medium">
            Start Free <ArrowRight className="ml-2 w-5 h-5" />
          </Button>
          <Button size="lg" variant="outline" className="rounded-full px-8 h-14 bg-white/50 backdrop-blur-sm border-purple-100 hover:bg-purple-50 text-gray-700 hover:text-purple-700 transition-all text-base font-medium group">
            <Play className="mr-2 w-5 h-5 text-purple-500 group-hover:scale-110 transition-transform" /> Watch Demo
          </Button>
        </motion.div>
        ...
        >
          ...
          >
             ...
             <div className="flex -space-x-2">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div key={i} className="w-8 h-8 rounded-full border-2 border-white bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center text-[10px] font-bold text-purple-700">
                    A{i}
                  </div>
                ))}
             </div>
