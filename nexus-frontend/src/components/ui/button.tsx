...
const buttonVariants = cva(
  "group/button relative inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-300 outline-none select-none focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 overflow-hidden",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-[#4F7CFF] via-[#7B5CFF] to-[#2FD9FF] text-white shadow-[0_10px_30px_rgba(79,124,255,0.3)] hover:shadow-[0_15px_40px_rgba(123,92,255,0.5)] border border-white/40 hover:scale-[1.03] bg-[length:200%_auto] hover:bg-[right_center] transition-all duration-500",
        outline:
          "bg-white/10 backdrop-blur-md text-[#0A121A] border border-[#7B5CFF]/30 hover:border-transparent hover:bg-white/30 hover:shadow-[0_0_30px_rgba(79,124,255,0.2)] hover:scale-[1.02] relative before:absolute before:inset-0 before:-z-10 before:rounded-[inherit] before:bg-gradient-to-r before:from-[#4F7CFF] before:via-[#7B5CFF] before:to-[#2FD9FF] before:p-[2px] before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-500 before:mask-[linear-gradient(#fff, #fff) content-box, linear-gradient(#fff, #fff)] before:mask-composite-[exclude]",
        secondary:
