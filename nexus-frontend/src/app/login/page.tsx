...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex w-full relative overflow-hidden bg-[#FCFDFF]">
      <div className="absolute inset-0 bg-gradient-to-tr from-[#4F7CFF]/5 to-[#7B5CFF]/5 opacity-40 mix-blend-multiply pointer-events-none" />
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 xl:px-24 relative z-10">
        ...
        >
          ...
          <Button onClick={handleGoogleLogin} variant="outline" className="w-full h-14 rounded-xl mb-4 font-medium text-[#0A121A] bg-white/60 backdrop-blur-md hover:bg-white/80 border-white/60 shadow-sm transition-all text-base">
